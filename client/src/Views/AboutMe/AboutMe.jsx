...
import foto from "../../img-pk/about/SebaLemos.jpg";
        ...
        <div className={style.containerDetail}>
          <div className={style.imagenConRedes}>
            ...
            <div className={style.links}>
              <a
                href="https://www.linkedin.com/in/sebastian-lemos"
                target="_blank"
                rel="noreferrer"
              >
                <svg
              ...
              <a
                href="https://github.com/SebaALemos"
                target="_blank"
                rel="noreferrer"
              >
                <svg
              ...
              <a
                href="mailto:sebastian.lemos94@gmail.com"
                target="_blank"
                rel="noreferrer"
              >
                <svg
          ...
          <div className={style.contentDetail}>
            <h1 className={style.pokemonNameDetail}>Sebastián Lemos</h1>
